...
{
    cout<<endl;
    cout<<"The Department Door is Locked.\nThere is a keypad with a note\n";
    cout<<"I speak without a mouth and hear without ears. What am I?\n";
    string answer;
    cin>>answer;


    if(answer=="echo" || answer=="Echo" || answer=="ECHO") {
    cout << "           YOU'RE IN CHEMISTRY LAB\n";
...
void civilDepartment()
{
    ...
    cout<< "          CIVIL DEPARTMENT\n";
     cout<<endl;
     cout<<"You find a dusty old box\n";
     cout<<"There is a lock!\n";
     cout<<"Answer to this question is the password:: x^2-5x+6=0\n";
     int value;
     cin>>value;

     if(value==23)
        {
        cout << "You find an old underground blueprint inside the box.\n";
